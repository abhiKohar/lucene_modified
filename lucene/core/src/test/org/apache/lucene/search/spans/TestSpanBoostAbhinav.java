...
public class TestSpanBoostAbhinav extends LuceneTestCase {
...
// test boosting for nested queries
    SpanTermQuery q11 =  new SpanTermQuery(new Term("foo", "bar"));
    SpanTermQuery q12 =  new SpanTermQuery(new Term("foo", "baz"));
    SpanNearQuery q1 = new SpanNearQuery(new SpanQuery[] { q11}, 10, true);
    //q1.setBoost(2.0);
    SpanBoostQuery bq1 = new SpanBoostQuery(q1, 2);
    SpanNearQuery q2 = new SpanNearQuery(new SpanQuery[] { q12}, 10, true);
    //q2.setBoost(3.0);
    SpanBoostQuery bq2 = new SpanBoostQuery(q1, 3);
...
//    assertTrue(expected.getMessage().contains("must have same field"));
    ...
    SpanNearQuery nspan =  new SpanNearQuery(new SpanQuery[] { bq1, bq2 }, 10, true);
    SpanBoostQuery bnspan = new SpanBoostQuery(nspan, 5);
    //bnspan.createWeight(newSearcher(),true);
